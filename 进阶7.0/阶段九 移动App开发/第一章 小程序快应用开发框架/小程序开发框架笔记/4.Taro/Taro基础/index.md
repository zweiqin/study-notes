...
![image-20221002121428916](index.assets/image-20221002121428916-16646840728721.png)
...
小程序的全局配置文件在`app.js`文件中的 `config`字段中。[小程序全局配置](https://developers.weixin.qq.com/miniprogram/dev/framework/config.html)。
