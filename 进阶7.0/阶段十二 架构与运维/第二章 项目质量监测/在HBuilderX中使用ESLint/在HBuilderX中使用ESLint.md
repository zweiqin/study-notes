...
<img src="在HBuilderX中使用ESLint.assets/image-20220814235929188.png" alt="image-20220814235929188" style="zoom:50%;" />

<img src="在HBuilderX中使用ESLint.assets/image-20220815000008644.png" alt="image-20220815000008644" style="zoom:50%;" />

### HBuilderX-进行设置

##### 打开设置

<img src="在HBuilderX中使用ESLint.assets/image-20220815000200373.png" alt="image-20220815000200373" style="zoom: 80%;" />

##### 在常用配置-制表符长度-设置为2

（注意不要勾选下面的空格代替字符串）

<img src="在HBuilderX中使用ESLint.assets/image-20220815000311805.png" alt="image-20220815000311805" style="zoom:80%;" />

##### 在编辑器配置-选择默认换行符\n

<img src="在HBuilderX中使用ESLint.assets/image-20220815181935860.png" alt="image-20220815181935860" style="zoom:80%;" />

##### 在编辑器配置-勾选保存时自动格式化

<img src="在HBuilderX中使用ESLint.assets/image-20220815000540805.png" alt="image-20220815000540805" style="zoom:80%;" />

##### 在插件配置-勾选如下四条

<img src="在HBuilderX中使用ESLint.assets/image-20220815000645533.png" alt="image-20220815000645533" style="zoom:80%;" />

### 相关文件进行设置

##### 打开文件prettier.config.js文件进行配置
...
##### 在项目根目录下新建.eslintrc.js文件并配置

例如该图：

<img src="在HBuilderX中使用ESLint.assets/image-20220815001129320.png" alt="image-20220815001129320" style="zoom:80%;" />
...
parserOptions（对象）属性下的parser属性的值为'esprima'。
